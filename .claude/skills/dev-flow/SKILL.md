...
- **Service files need a note.** If touching `teach-me-eng-bot.service` or `install-service.sh`, call it out in the PR — these affect the systemd-managed deployment on the host.
